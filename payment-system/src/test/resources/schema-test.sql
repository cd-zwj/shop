...
CREATE TABLE IF NOT EXISTS coupon_template (
  ...
  valid_type VARCHAR(20) NOT NULL DEFAULT 'FIXED_DAYS',
  valid_days INT DEFAULT NULL,
  valid_start_time TIMESTAMP DEFAULT NULL,
  valid_end_time TIMESTAMP DEFAULT NULL,
  can_stack_balance TINYINT NOT NULL DEFAULT 1,
  can_stack_points TINYINT NOT NULL DEFAULT 1,
  can_stack_other_coupon TINYINT NOT NULL DEFAULT 0,
  applicable_product_scope VARCHAR(20) NOT NULL DEFAULT 'ALL',
  applicable_product_json TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS user_coupon (
  ...
  source_type VARCHAR(20) NOT NULL DEFAULT 'RECEIVE',
