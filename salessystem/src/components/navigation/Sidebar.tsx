...
export function Sidebar() {
  ...
  const merchantMenu: Array<{
    ...
    { icon: Warehouse, label: '门店库存', path: '/merchant/inventory', permission: 'inventory:manage' },
    ...
    { icon: MessageSquare, label: '门店评价', path: '/merchant/reviews', permission: 'order:manage' },
